...
<asp:Content runat="server" ID="BodyContent" ContentPlaceHolderID="MainContent">
    ...
    <%--
        ...
        Description : Displays the login form for the Student Information System.
        Technologies: ASP.NET Web Forms + Bootstrap 5
        =============================================
    --%>
                ...
                <div class="col-md-6">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <!-- Sign In button -->
                            <div class="d-grid">
                                <asp:Button ID="btnLogin" runat="server" Text="Sign In" CssClass="btn btn-primary btn-lg" OnClick="btnLogin_Click" />
                            </div>
