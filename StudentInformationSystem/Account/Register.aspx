...
<asp:Content runat="server" ID="BodyContent" ContentPlaceHolderID="MainContent">
    ...
    <%--
        ...
        ------------------------------------------------------------------------------------------
        • Renders the registration form for new student accounts.
        • Uses Bootstrap 5 for layout + styling.
        ==========================================================================================
    --%>

    <main aria-labelledby="title"><!-- Accessibility landmark -->
        <div class="container"><!-- Bootstrap container -->
            <div class="row justify-content-center"><!-- Center column -->
                <div class="col-md-6"><!-- 6‑col width on ≥md -->
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <%-- Summary of any validation errors --%>
                            ...
                            <div class="row mb-3">
                                <div class="col-md-6">
                                    ...
                                    <asp:RequiredFieldValidator ID="rfvFirstName" runat="server" ControlToValidate="txtFirstName" CssClass="text-danger small" ErrorMessage="First name is required." Display="Dynamic" />
                                </div>
                                <div class="col-md-6">
                                    ...
                                    <asp:RequiredFieldValidator ID="rfvLastName" runat="server" ControlToValidate="txtLastName" CssClass="text-danger small" ErrorMessage="Last name is required." Display="Dynamic" />
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                <div class="col-md-12">
                                    ...
                                    <asp:RegularExpressionValidator ID="revEmail" runat="server" ControlToValidate="txtEmail" CssClass="text-danger small" ErrorMessage="Please enter a valid email address." ValidationExpression="^[\w\.-]+@[\w\.-]+\.\w+$" Display="Dynamic" />
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                <div class="col-md-6">
                                    ...
                                    <asp:RegularExpressionValidator ID="revPassword" runat="server" ControlToValidate="txtPassword" CssClass="text-danger small" ErrorMessage="Password must be at least 6 characters long." ValidationExpression=".{6,}" Display="Dynamic" />
                                ...
                                <div class="col-md-6">
                                    ...
                                    <asp:RequiredFieldValidator ID="rfvConfirmPassword" runat="server" ControlToValidate="txtConfirmPassword" CssClass="text-danger small" ErrorMessage="Password confirmation is required." Display="Dynamic" />
                                    <asp:CompareValidator ID="cvPassword" runat="server" ControlToCompare="txtPassword" ControlToValidate="txtConfirmPassword" CssClass="text-danger small" ErrorMessage="Passwords do not match." Display="Dynamic" />
                                </div>
                            </div>

                            <%-- Static role notice (always "Student") --%>
                            ...
                            <div class="row">
                                <div class="col-md-12 text-center">
                                    <asp:Button ID="btnRegister" runat="server" Text="Create Student Account" CssClass="btn btn-primary btn-lg px-5" OnClick="btnRegister_Click" />
                                    <div class="mt-3">
